...
namespace CodeEditorWinForms
{
	public partial class CodeEditor : Form
	{
		...
		string FileDialogFilterAny = "Any file|*.*";
		...
		private void InitEditor(FastColoredTextBox editor)
		{
			editor.Dock = DockStyle.Fill;
			editor.ContextMenuStrip = contextMenuStrip1;
			editor.KeyDown += codeEditor_KeyDown;

			SetAutocompleteMenu(editor);
			SetEditorStyle(editor);
		}

		private void SetAutocompleteMenu(FastColoredTextBox editor)
		{
			// autocomplete menu
